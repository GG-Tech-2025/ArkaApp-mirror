...
// Conservative row caps so a page never overflows even when a couple of rows
// wrap to two lines (long location names, etc). Tune here if the layout
// (fonts, padding) changes.
...
>(({ customer, orders, payments, writeOffs, fromDate, toDate }, ref) => {
  ...
  useImperativeHandle(ref, () => pageRefs.current, [totalPages]);
        ...
        return (
          ...
          >
            ...
            <div style={{ marginTop: "20px", marginBottom: "20px" }}>
              ...
              {totalPages > 1 && (
                <p><strong style={{ color: '#a6110b' }}>Page:</strong> {pageIndex + 1} of {totalPages}</p>
              )}
            </div>
            ...
            {/* Final Outstanding (last page only) */}
            {isLastPage && (
